...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private boolean validarCampos() {
        if (campoLogin.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "É obrigatorio prencher o campo Login", "ERRO", JOptionPane.ERROR_MESSAGE);
            return false;
        } else if (campoSenha.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "É obrigatorio prencher o campo Senha", "ERRO", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        return true;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (validarCampos()) {
            ...
            try {
                ...
                Usuario usuario = usuarioDAO.buscarUsuarioPorLoginSenha(l.getLogin(), l.getSenha());
                if (usuario == null) {
